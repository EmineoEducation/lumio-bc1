...
//  Remplace 
// ── Correctifs RETEX juin 2026 — Finder + portraits + desktop ──────────────
window.LUMIO_DATA.finder       = {"folders": {"guide": {"title": "Guide de mission", "sidebar": "⌘ Guide", "icon": "📕", "items": [{"kind": "pdf", "name": "Guide de mission", "app": "pdf", "props": {"openGuide": true}}]}, "mission": {"title": "Mission — Dossier complet", "sidebar": "Mission", "icon": "🗂", "items": [{"kind": "folder", "name": "Acte 1 — Ancrage", "folder": "acte1"}, {"kind": "folder", "name": "Acte 2 — Entrée affaire", "folder": "acte2"}, {"kind": "folder", "name": "Acte 3 — Diagnostic", "folder": "acte3"}, {"kind": "folder", "name": "Acte 4 — Production", "folder": "acte4"}, {"kind": "folder", "name": "Portraits équipe", "folder": "portraits"}]}, "acte1": {"title": "Acte 1", "sidebar": "Acte 1", "icon": "📁", "items": [{"kind": "mail", "name": "Mission de diagnostic de marque", "app": "mail", "props": {"openId": "brief"}}, {"kind": "mail", "name": "Re : Réserves CEO sur le repositionnement", "app": "mail", "props": {"openId": "theo"}}]}, "acte2": {"title": "Acte 2", "sidebar": "Acte 2", "icon": "📁", "items": [{"kind": "pdf", "name": "Note de cadrage Sonia Ferracci", "app": "pdf", "props": {"openDoc": "d1"}}, {"kind": "pdf", "name": "Rapport veille wearables santé", "app": "pdf", "props": {"openDoc": "d2"}}]}, "acte3": {"title": "Acte 3", "sidebar": "Acte 3", "icon": "📁", "items": [{"kind": "pdf", "name": "Verbatims Camille Ott — terrain", "app": "pdf", "props": {"openDoc": "d3"}}]}, "acte4": {"title": "Acte 4", "sidebar": "Acte 4", "icon": "📁", "items": [{"kind": "pdf", "name": "Note de cadrage — production livrable", "app": "pdf", "props": {"openGuide": true}}]}, "portraits": {"title": "Portraits équipe", "sidebar": "Portraits", "icon": "🪪", "items": [{"kind": "html", "name": "Théo Marczak — CEO", "app": "browser", "props": {"openPortrait": "theo"}}, {"kind": "html", "name": "Sonia Ferracci — Dir. Marketing", "app": "browser", "props": {"openPortrait": "sonia"}}, {"kind": "html", "name": "Camille Ott — Partenariats B2B", "app": "browser", "props": {"openPortrait": "camille"}}, {"kind": "html", "name": "Yassine Morel — Content Manager", "app": "browser", "props": {"openPortrait": "yassine"}}, {"kind": "html", "name": "Jakob Rein — Northgate Capital", "app": "browser", "props": {"openPortrait": "jakob"}}]}}, "order": ["guide", "mission", "acte1", "acte2", "acte3", "acte4", "portraits"]};
window.LUMIO_DATA.portraits    = [{"key": "theo", "id": "portrait-theo", "title": "Théo Marczak — CEO", "tabTitle": "Théo Marczak", "favicon": "T", "faviconColor": "#0a3d62", "host": "lusinedigitale.fr", "url": "lusinedigitale.fr/portrait/theo-marczak", "file": "portraits/portrait_theo_marczak.html"}, {"key": "sonia", "id": "portrait-sonia", "title": "Sonia Ferracci — Dir. Marketing", "tabTitle": "Sonia Ferracci", "favicon": "S", "faviconColor": "#a02020", "host": "cbnews.fr", "url": "cbnews.fr/portrait/sonia-ferracci", "file": "portraits/portrait_sonia_ferracci.html"}, {"key": "camille", "id": "portrait-camille", "title": "Camille Ott — Partenariats B2B", "tabTitle": "Camille Ott", "favicon": "C", "faviconColor": "#1a6641", "host": "actionco.fr", "url": "actionco.fr/portrait/camille-ott", "file": "portraits/portrait_camille_ott.html"}, {"key": "yassine", "id": "portrait-yassine", "title": "Yassine Morel — Content Manager", "tabTitle": "Yassine Morel", "favicon": "Y", "faviconColor": "#e85d3a", "host": "maddyness.com", "url": "maddyness.com/portrait/yassine-morel", "file": "portraits/portrait_yassine_morel.html"}, {"key": "jakob", "id": "portrait-jakob", "title": "Jakob Rein — Northgate Capital", "tabTitle": "Jakob Rein", "favicon": "J", "faviconColor": "#1b3a6b", "host": "forbes.fr", "url": "forbes.fr/portrait/jakob-rein", "file": "portraits/portrait_jakob_rein.html"}];
window.LUMIO_DATA.desktopIcons = [{"app": "finder", "folder": "mission", "label": "Mission", "kind": "folder"}, {"app": "finder", "folder": "portraits", "label": "Portraits équipe", "kind": "folder"}, {"app": "mail", "label": "Mail", "kind": "app"}, {"app": "slack", "label": "Slack", "kind": "app"}, {"app": "notepad", "label": "Mes notes.txt", "kind": "app"}];
if (!window.LUMIO_DATA.voiceMemos || !window.LUMIO_DATA.voiceMemos.length) {
  window.LUMIO_DATA.voiceMemos = [{"title": "Débrief RDV — terrain B2B", "author": "Camille Ott", "role": "Responsable partenariats B2B", "date": "Mars 2025", "context": "mémo dicté après réunion", "durationSec": 44, "transcript": "Réunion ce matin avec un prospect grand compte. Le sujet qui bloque encore, c'est la certification MDR — sans ça, le service achats ne peut pas mettre notre produit en comité. Côté fonctionnel, la demande est claire : tableau de bord agrégé, données anonymisées, hébergement France. Le commercial peut avancer si Théo confirme l'engagement sur la souveraineté des données d'ici fin de semaine."}, {"title": "Note terrain — signaux concurrents", "author": "Camille Ott", "role": "Responsable partenariats B2B", "date": "Avril 2025", "context": "mémo dicté en déplacement", "durationSec": 36, "transcript": "Deux signaux à remonter à Sonia. Un : Nurosym fait des démos en direct chez nos prospects — ils avancent vite sur le segment mutuelles. Deux : les acheteurs RH commencent à demander des références CSRD dans les appels d'offre. C'est nouveau. Notre deck ne le mentionne pas encore. À corriger avant le prochain board."}];
}
